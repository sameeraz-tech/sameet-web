...
sameet Browser Client
Copyright (C) 2021 SAMAPPS
...
let recStartTime;
let recElapsedTime;
let sameetTheme = "neon"; // neon - dark - forest - ghost ...
...
function welcomeUser() {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      let message = {
        email: "",
        subject: "Please join our sameet Video Chat Meeting",
    ...
    event.channel.onmessage = (msg) => {
      switch (event.channel.label) {
        case "sameet_chat_channel":
          ...
          break;
        case "sameet_file_sharing_channel":
...
/**
 * Set sameet theme neon - dark - forest - sky - ghost
 * @param {*} theme
 */
  ...
  if (isImageURL(incomingFileInfo.fileName)) {
    ...
    reader.onload = (e) => {
      Swal.fire({
        ...
        imageAlt: "sameet-file-img-download",
        showDenyButton: true,
...
function getAbout() {
  ...
  Swal.fire({
    background: swalBackground,
    position: "center",
    title: "<strong>SAMAPPS INC</strong>",
    imageAlt: "sameet-about",
    html: `
    <br/>
    <div id="about">
      <b>SAMEET</b> BY
    </div></br>
    <div id="author">Author:<a href="https://sameet.netlify.app" target="_blank"> SamApps</a></div>
    `,
    showClass: {
      popup: "animate__animated animate__fadeInDown",
    },
